...
def test_create_site_with_position():
    ...
    # Site p has geopandas information which we compare with position.
    # Location is a geopandas dataframe which might output a list of equal positions.
    # The index refers to which item in that list.
